...
'use strict';
	...
	function edit() {
		...
		/* 	Die bereits erstellten Felder für die Zutaten des Rezeptes werden eingeblendet, 
			die Menge mit options beladen und das passende Element ausgewählt
		*/
		...
		document.getElementById("zutaten").style.display = "block";
		...
		// Kochzeit, Vorbereitungszeit, Schwierigkeit und Portionen editierbart setzen
