...
<body>
	...
	<div id="Einstellungen" class="clearfix">
		<h1>
	...
	<%-- Bild vom Rezept --%> <c:if test="${not empty rezept.filename}">
	...
	<div id="details">
		...
		<label for="durationPreparation">Vorbereitungszeit</label> <input
			...
			max="500" 
			form="editForm"
			value="${rezept.durationPreparation}"> <br> 
		<label for="durationCooking">Kochzeit</label><input 
			...
			min="0" max="500"
			form="editForm" 
			value="${rezept.durationCooking}"> <br>
		<label for="difficulty">Schwierigkeitsgrad</label> <input
			disabled
			type="number" 
			name="difficulty" 
			id="difficulty" 
			...
			min="0"
			form="editForm" 
			value="${rezept.difficulty}"> <br> 
		<label for="servings">Portionen</label> <input 
			disabled 
			type="number"
			name="servings" 
			id="servings" 
	...
	<div>
		...
		<form id="editForm" action="/rezeptbuch/EditRecipeServlet"
			...
			<label class="labelfortextarea headline">Zutaten</label>
				...
				<c:forEach var="ingredient" items="${rezept.ingredients}">
					<div class="newLine">
						<input type="number" name="zutatenMenge" class="zutatenMenge"
							placeholder="Menge" value="${ingredient.quantity}"> <select
			...
			<div id="editRecipe">
				...
				<label class="headline" for="description">Beschreibung</label>
